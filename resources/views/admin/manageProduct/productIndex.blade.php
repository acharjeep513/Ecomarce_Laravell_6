...
<div class='container' >
    <div class="row">
        <div class="col-md-4" >
          ...
          <a href="{{url('/adminAddProduct')}}"  class="list-group-item list-group-item-action" style="height: 60px;margin: 20px;background:'black'">Add Product</a>
          <a href="{{url('/adminProductShow')}}"  class="list-group-item list-group-item-action"style="height: 60px;margin: 20px">Show product</a>
