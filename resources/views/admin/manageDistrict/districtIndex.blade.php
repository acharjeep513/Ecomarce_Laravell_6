...
<div class='container' >
	  <div class="row" style="height: 65px;border-top: 10px">
	  	<div class="col-md-12">
	  		<h5 align="center">District Managment</h5>
	  	</div>
	  </div>
    <div class="row">
        <div class="col-md-4" >
          ...
          <a href="{{url('/adminAddDistrict')}}"  class="list-group-item list-group-item-action" style="height: 60px;margin: 20px;background:'black'">Add District</a>
          <a href="{{url('/adminShowDistrict')}}"  class="list-group-item list-group-item-action"style="height: 60px;margin: 20px">Show District</a>
